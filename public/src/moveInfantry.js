...
var canMoveToAura = require('./canMoveToAura');
var add = require('./utils/add');

var js = M.toJs;
var clj = M.toClj;

function moveInfantry(map, [di, dj], [ui, uj]) {
  // TODO: path finding
  ...
  if (destColor !== ownColor &&
      destColor !== 'Gray' &&
      !canMoveToAura(map, 'Infantry', destColor, [di, dj])) {
    return map;
  }
